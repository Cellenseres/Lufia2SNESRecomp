...
static const WholeTarget kWholeTargets[30] = {
...
int main(int argc, char **argv) {
    ...
    unsigned fb12_oob = 0;
    unsigned whole_passed[30] = {0};
    WholeStats whole_stats[30];
    unsigned failed = 0;
    ...
    for (unsigned t = 0; t < 30u && failed < 20; ++t) {
